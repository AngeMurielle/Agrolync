...
class FungicideCartPage extends StatefulWidget {
  const FungicideCartPage({super.key});

  @override
  State<FungicideCartPage> createState() => _FungicideCartPageState();
}

class _FungicideCartPageState extends State<FungicideCartPage> {
