...
class SyntheticInsecticideCartPage extends StatefulWidget {
  const SyntheticInsecticideCartPage({super.key});

  @override
  State<SyntheticInsecticideCartPage> createState() =>
      _SyntheticInsecticideCartPageState();
}

class _SyntheticInsecticideCartPageState
    extends State<SyntheticInsecticideCartPage> {
  final List<Map<String, dynamic>> _cartItems = [
    {
      ...
      'price': 2500,
      'quantity': 1,
      'image': 'assets/images/synthetic_insecticide.jpg'
    },
  ];
