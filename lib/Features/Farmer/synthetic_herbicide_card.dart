...
class SyntheticHerbicideCartPage extends StatefulWidget {
  const SyntheticHerbicideCartPage({super.key});

  @override
  State<SyntheticHerbicideCartPage> createState() =>
      _SyntheticHerbicideCartPageState();
}

class _SyntheticHerbicideCartPageState
    extends State<SyntheticHerbicideCartPage> {
  final List<Map<String, dynamic>> _cartItems = [
    {
      'name': 'Synthetic Herbicide',
      'weight': 'bottle',
      'price': 30.00,
      'quantity': 1,
      'image': 'assets/images/synthetic_herbicide.jpg'
    },
  ];
