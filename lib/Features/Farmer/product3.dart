        ...
        child: Column(
          children: [
            ...
            Stack(
              children: [
                Image.asset(
                  'assets/images/tomato.jpg', // Specific asset path
                  ...
                  children: [
                    Expanded(
                        child: _buildStatCard(Icons.payments_outlined,
                            "PRICE PER UNIT", "2500 XAF", "/ Big Basket")),
                    const SizedBox(width: 16),
                    Expanded(
                        child: _buildStatCard(Icons.warehouse_outlined,
                            "STOCK AVAILABLE", "350", "Backets")),
                  ],
                ),
              ),
            ),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      "'Rio Grande' Organic Plum Tomatoes (Firm & Fleshy)\nThese are thick-walled, deep-red organic tomatoes grown in the volcanic soils of Santa. We harvest them at the 'pink stage' to ensure they arrive at your doorstep perfectly ripe and bruise-free. Our 'Rio Grande' variety is famous for its low seed count and high pulp, making it the best choice for thick, rich Tomato Stew or Poulet DG. Hand-picked and sorted to guarantee zero rotten pieces in your crate!",
                      style: TextStyle(
                    ...
                    Table(
                      children: [
                        TableRow(children: [
                          _buildGridItem("HARVEST DATE", "Sep 15, 2026"),
                          _buildGridItem("MOISTURE LEVEL", "90%"),
                        ]),
