...
class CarrotSeedsDetails extends StatefulWidget {
  const CarrotSeedsDetails({super.key});

  @override
  State<CarrotSeedsDetails> createState() => _CarrotSeedsDetailsState();
}

class _CarrotSeedsDetailsState extends State<CarrotSeedsDetails> {
  int _quantity = 1;
  final int _unitPrice = 1400;
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                        image: AssetImage('assets/images/carrots.jpg'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    "High-quality carrot seeds with excellent germination. Ideal for early, mid-season and late crops.",
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      final product = Product(
                        ...
                        unit: 'packet',
                        image: 'assets/images/carrot_seeds.jpg',
                        description: 'High-yield carrot seeds',
  ...
  Widget _buildSpecGrid() {
    final specs = [
      {'label': 'Variety', 'value': 'Chantenay'},
      {'label': 'Color', 'value': 'Orange'},
      {'label': 'Yield', 'value': 'Very High'},
      {'label': 'Germination', 'value': '94%'},
    ];
