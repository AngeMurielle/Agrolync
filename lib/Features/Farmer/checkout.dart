...
class _CheckoutScreenState extends State<CheckoutScreen> {
      ...
      Navigator.pushReplacement(
        ...
        MaterialPageRoute(
          builder: (context) => PaymentSuccessScreen(
            totalAmount:
                _totalAmount, // Fixed: changed 'amount' to 'totalAmount'
            transactionId:
                "AGL-${DateTime.now().millisecondsSinceEpoch.toString().substring(7)}",
          ),
        ),
      );
    });
        ...
        children: [
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildPaymentOption("MoMo", "MTN MoMo", "FAST & SECURE",
                    Icons.phone_android, const Color(0xFFFFCC00)),
                _buildPaymentOption("Orange", "Orange Money", "MOBILE TRANSFER",
                    Icons.tablet_android, const Color(0xFFFF6600)),
          ...
          if (_isProcessing)
            Container(
                ...
                child: const Center(
                    child:
                        CircularProgressIndicator(color: Color(0xFF026139)))),
        ],
      ),
  ...
  Widget _buildDeliveryInfoCard() => Container(
        ...
        child: Column(
          children: [
            _infoRow(Icons.location_on, "Delivery Address",
                "AgroLync Hub, Yaoundé", true),
  ...
  Widget _infoRow(IconData icon, String title, String sub, bool hasEdit) => Row(
        children: [
          CircleAvatar(
              ...
              child: Icon(icon, color: const Color(0xFF026139), size: 20)),
              ...
              .map((item) => Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text("XAF ${item['price'] * item['quantity']}",
                            style: const TextStyle(
                                fontWeight: FontWeight.bold,
                                color: Color(0xFF026139))),
                      ],
  ...
  Widget _buildPaymentOption(
      String id, String title, String sub, IconData icon, Color color) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(
                color:
                    isSelected ? const Color(0xFF026139) : Colors.transparent,
                width: 2)),
        child: Row(
          children: [
            Container(
