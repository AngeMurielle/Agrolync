        ...
        child: Column(
          children: [
            ...
            Stack(
              children: [
                Image.asset(
                  'assets/images/maize.jpg', // Specific asset path
                  ...
                  children: [
                    Expanded(
                        child: _buildStatCard(Icons.payments_outlined,
                            "PRICE PER UNIT", "35.000 XAF", "/ Bag of 100kg")),
                    const SizedBox(width: 16),
                    Expanded(
                        child: _buildStatCard(Icons.warehouse_outlined,
                            "STOCK AVAILABLE", "500", "Bags")),
                  ],
                ),
              ),
            ),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      "Premium quality organic yellow maize.This is 100% organic, sun-dried yellow maize grown in the fertile soils of the Buea. We use zero chemical fertilizers, relying only on natural compost and crop rotation to keep the land rich. These grains are heavy, weevil-free, and perfect for grinding into high-quality flour or feeding your organic poultry. Straight from the farm to your pot!",
                      style: TextStyle(
                    ...
                    Table(
                      children: [
                        TableRow(children: [
                          _buildGridItem("HARVEST DATE", "March 20, 2026"),
                          _buildGridItem("MOISTURE LEVEL", "12.5%"),
                        ]),
