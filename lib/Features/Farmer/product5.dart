...
class Product5Page extends StatefulWidget {
  const Product5Page({super.key});

  @override
  State<Product5Page> createState() => _Product5PageState();
}

class _Product5PageState extends State<Product5Page> {
  final ImagePicker _picker = ImagePicker();

  // Color Palette based on Agrolync Branding
        ...
        child: Column(
          children: [
            ...
            Stack(
              children: [
                Image.asset(
                  'assets/images/carrot.jpg', // Specific asset path
                  ...
                  children: [
                    Expanded(
                        child: _buildStatCard(Icons.payments_outlined,
                            "PRICE PER UNIT", "15.000 XAF", "/ Bag of 50kg")),
                    const SizedBox(width: 16),
                    Expanded(
                        child: _buildStatCard(Icons.warehouse_outlined,
                            "STOCK AVAILABLE", "250", "Bags")),
                  ],
                ),
              ),
            ),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      "These are premium, straight-tapered carrots grown in the rich, loose volcanic soils of the Bafou highlands. Our 'Sweet Nantes' variety is famous for its high sugar content and lack of a woody core, making it the best choice for fresh juices, Salade Macédoine, or a sweet crunch in your Fried Rice. Every carrot is hand-washed in spring water and sorted by size to ensure you get only the smoothest, blemish-free roots. 100% chemical-free for your family’s health!",
                      style: TextStyle(
                    ...
                    Table(
                      children: [
                        TableRow(children: [
                          _buildGridItem("HARVEST DATE", "Dec 18, 2026"),
                          _buildGridItem("MOISTURE LEVEL", "86%"),
                        ]),
