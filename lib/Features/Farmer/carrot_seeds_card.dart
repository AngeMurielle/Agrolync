...
class CarrotSeedsCartPage extends StatefulWidget {
  const CarrotSeedsCartPage({super.key});

  @override
  State<CarrotSeedsCartPage> createState() => _CarrotSeedsCartPageState();
}

class _CarrotSeedsCartPageState extends State<CarrotSeedsCartPage> {
