...
class RodenticideCartPage extends StatefulWidget {
  const RodenticideCartPage({super.key});

  @override
  State<RodenticideCartPage> createState() => _RodenticideCartPageState();
}

class _RodenticideCartPageState extends State<RodenticideCartPage> {
