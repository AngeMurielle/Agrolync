...
class TomatoseedCardPage extends StatefulWidget {
  const TomatoseedCardPage({super.key});

  @override
  State<TomatoseedCardPage> createState() => _TomatoseedCardPageState();
}

class _TomatoseedCardPageState extends State<TomatoseedCardPage> {
  int quantity = 1;
  final double pricePerUnit = 10.00;
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            '${pricePerUnit.toStringAsFixed(2).replaceAll(RegExp(r'\.0+$'), '')} XAF / pkt',
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                              '$quantity packet(s) of Tomato Seeds added to cart!'),
                        ),
                      );
