...
class HerbicideCardPage extends StatefulWidget {
  ...
  @override
  State<HerbicideCardPage> createState() => _HerbicideCardPageState();
}
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                              '$quantity unit(s) of Herbicide added to cart!'),
                        ),
                      );
