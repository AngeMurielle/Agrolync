...
class GardenHoseCartPage extends StatefulWidget {
  const GardenHoseCartPage({super.key});

  @override
  State<GardenHoseCartPage> createState() => _GardenHoseCartPageState();
}

class _GardenHoseCartPageState extends State<GardenHoseCartPage> {
