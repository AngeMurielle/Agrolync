...
class MagnesiumSulfateCartPage extends StatefulWidget {
  const MagnesiumSulfateCartPage({super.key});
  @override
  State<MagnesiumSulfateCartPage> createState() =>
      _MagnesiumSulfateCartPageState();
}

class _MagnesiumSulfateCartPageState extends State<MagnesiumSulfateCartPage> {
  ...
  double get _shippingFee => _subtotal * 0.07;
  double get _totalPrice => _subtotal + _shippingFee;
