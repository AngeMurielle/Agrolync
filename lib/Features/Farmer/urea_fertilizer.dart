...
class UreaFertilizerDetails extends StatefulWidget {
  const UreaFertilizerDetails({super.key});

  @override
  State<UreaFertilizerDetails> createState() => _UreaFertilizerDetailsState();
}
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                        image: AssetImage('assets/images/urea_fertilizer.jpg'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    "High-quality urea fertilizer with 46% nitrogen content. Ideal for all crop types and soil conditions.",
