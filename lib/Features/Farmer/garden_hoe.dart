...
class GardenHoeDetails extends StatefulWidget {
  const GardenHoeDetails({super.key});
  @override
  State<GardenHoeDetails> createState() => _GardenHoeDetailsState();
}

class _GardenHoeDetailsState extends State<GardenHoeDetails> {
  int _quantity = 1;
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                        image: AssetImage('assets/images/houe.jpg'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    "Heavy-duty garden hoe with comfortable grip. Perfect for weeding and soil preparation.",
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      final product = Product(
                        ...
                        description:
                            'Professional garden hoe for soil preparation',
