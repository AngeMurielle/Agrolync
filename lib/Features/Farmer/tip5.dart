...
class Tip5Page extends StatefulWidget {
  const Tip5Page({super.key});

  @override
  State<Tip5Page> createState() => _Tip5PageState();
}

class _Tip5PageState extends State<Tip5Page> {
        ...
        child: Column(
          ...
          children: [
            ...
            Stack(
              children: [
                Image.asset(
                  'assets/images/Tip5.png', // Using your specific asset
            ...
            Padding(
              ...
              child: Container(
                ...
                child: const Text(
                  "Boost soil health and fertility by sequentially rotating different types of crops on the same land.\nSequential planting of different crop families helps break the life cycles of pests and diseases that live in the soil. This practice also improves soil structure and nutrient balance, reducing the need for chemical inputs.",
                  style:
            ...
            _buildStrategyCard(
              index: "1",
              title: "Nitrogen Sequencing",
              description:
                  "Always follow heavy feeders (like maize) with nitrogen-fixers (like beans or peas) to naturally replenish the soil.",
              icon: Icons.grass,
              efficiency: "HIGH",
              cost: "LOW",
            ),
            ...
            _buildStrategyCard(
              ...
              title: "Family Breaks",
              description:
                  "Avoid planting crops from the same botanical family (e.g., tomatoes and potatoes) in the same spot for at least three seasons.",
              icon: Icons.sync,
              efficiency: "VITAL",
              cost: "MEDIUM",
            ),
                      ...
                      onPressed: () {
                        if (!_notificationsEnabled) {
                          ...
                          notificationProvider.addAgronomicTipsNotification(
                            tipsTitle: 'Systematic Crop Rotation',
                            tipsContent:
