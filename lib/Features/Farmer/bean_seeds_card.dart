...
class BeanSeedsCartPage extends StatefulWidget {
  const BeanSeedsCartPage({super.key});

  @override
  State<BeanSeedsCartPage> createState() => _BeanSeedsCartPageState();
}

class _BeanSeedsCartPageState extends State<BeanSeedsCartPage> {
