...
class NpkFertilizerCardPage extends StatefulWidget {
  ...
  @override
  State<NpkFertilizerCardPage> createState() => _NpkFertilizerCardPageState();
}
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    Image.asset(
                      'assets/images/npk_fertilizer.jpg',
                      width: 80,
                      height: 80,
                      fit: BoxFit.cover,
                    ),
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                              '$quantity bag(s) of NPK Fertilizer added to cart!'),
                        ),
                      );
