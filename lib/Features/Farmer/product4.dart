        ...
        child: Column(
          children: [
            ...
            Stack(
              children: [
                Image.asset(
                  'assets/images/beans.jpg', // Specific asset path
                  ...
                  children: [
                    Expanded(
                        child: _buildStatCard(Icons.payments_outlined,
                            "PRICE PER UNIT", "55.000 XAF", "/ Bag of 50kg")),
                    const SizedBox(width: 16),
                    Expanded(
                        child: _buildStatCard(Icons.warehouse_outlined,
                            "STOCK AVAILABLE", "300", "Bags")),
                  ],
                ),
              ),
            ),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      " These are premium, stringless green beans grown in the volcanic, pesticide-free soils of Santa. We harvest them young to ensure they are tender, vibrant green, and have that satisfying 'snap' when broken. Perfect for sautéing with garlic, adding to Salade Macédoine, or a quick stir-fry. Packed in breathable crates immediately after morning harvest to maintain their field-fresh moisture and prevent wilting.",
                      style: TextStyle(
