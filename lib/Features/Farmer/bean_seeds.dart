...
class BeanSeedsDetails extends StatefulWidget {
  const BeanSeedsDetails({super.key});

  @override
  State<BeanSeedsDetails> createState() => _BeanSeedsDetailsState();
}

class _BeanSeedsDetailsState extends State<BeanSeedsDetails> {
  int _quantity = 1;
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                        image: AssetImage('assets/images/beans seed.jpg'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    "High-quality bean seeds suitable for various growing conditions. Packed with nutrients and designed for optimal germination.",
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      final product = Product(
                        ...
                        unit: 'packet',
                        image: 'assets/images/bean_seeds.jpg',
                        description: 'High quality bean seeds for farming',
