...
class AmmoniumNitrateCartPage extends StatefulWidget {
  const AmmoniumNitrateCartPage({super.key});
  @override
  State<AmmoniumNitrateCartPage> createState() =>
      _AmmoniumNitrateCartPageState();
}

class _AmmoniumNitrateCartPageState extends State<AmmoniumNitrateCartPage> {
