...
class MagnesiumSulfateDetails extends StatefulWidget {
  const MagnesiumSulfateDetails({super.key});
  @override
  State<MagnesiumSulfateDetails> createState() =>
      _MagnesiumSulfateDetailsState();
}
...
class _MagnesiumSulfateDetailsState extends State<MagnesiumSulfateDetails> {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                        image:
                            AssetImage('assets/images/magnesium_sulfate.png'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    "High-quality magnesium sulfate for chlorophyll formation and enhanced photosynthesis.",
  ...
  Widget _buildSpecGrid() {
    final specs = [
      {'label': 'Magnesium', 'value': '9.8%'},
      {'label': 'Sulfur', 'value': '13%'},
      {'label': 'Grade', 'value': 'Pure'},
