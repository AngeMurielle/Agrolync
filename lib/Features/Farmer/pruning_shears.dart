...
class PruningshearsDetails extends StatefulWidget {
  const PruningshearsDetails({super.key});

  @override
  State<PruningshearsDetails> createState() => _PruningshearsDetailsState();
}
...
class _PruningshearsDetailsState extends State<PruningshearsDetails> {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                        image: AssetImage('assets/images/pruning_shears.jpg'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    "Professional-grade pruning shears with ergonomic grip and sharp steel blades. Ideal for precision cutting and trimming in garden maintenance.",
  ...
  Widget _buildSpecGrid() {
    final specs = [
      ...
      {'label': 'Blade Length', 'value': '20cm'},
      {'label': 'Grip', 'value': 'Ergonomic'},
      {'label': 'Weight', 'value': '0.3kg'},
    ];
